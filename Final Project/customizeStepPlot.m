function customizeStepPlot(varargin)
       % customizeStepPlot(sys1, lineColorStyle, sys2, lineColorStyle2, titleText, xLabel, yLabel, leg1)
    ...
    if nargin == 6
        step(sys1, lineColorStyle);
    else
        step(sys1, lineColorStyle, sys2, lineColorStyle2);
    end
